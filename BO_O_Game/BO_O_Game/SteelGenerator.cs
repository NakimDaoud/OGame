...
namespace BO_O_Game
{
    public class SteelGenerator : ResourceGenerator
    {
        ...
        override public List<Resource> ResourceBySecond()
        {
            ...
            List<Resource> resources = new List<Resource>();
            resources.Add(new Resource { Name = EnumResource.ACIER.ToString(), LastUpdate = DateTime.Now, LastQuantity = (10 * (Level / 2)) + 1 });
            return resources;
        }
